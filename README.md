...
- Chatbots for Healthcare entities
...
- Championing self-custody, privacy, and P2P free markets.
...
| **Languages** | Rust, TypeScript, JavaScript, Bash, Python |
| **Security** | Smart Contract Auditing, RustSec, Solana Program Vulnerabilities (Reentrancy, Overflow) |
