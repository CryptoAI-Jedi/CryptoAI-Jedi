...
## About Me
**Tier II/III Tech Support & Crypto Operations Specialist** with 5+ years managing datacenter infrastructure (2,000+ ASICs, 98% uptime) and a background in futures trading & risk management. Native crypto user (Bitcoin Class of 2018). Node operator since 2021 (Bitcoin & Monero—self-built from scratch). Currently upskilling toward Web3 infrastructure & support roles.
